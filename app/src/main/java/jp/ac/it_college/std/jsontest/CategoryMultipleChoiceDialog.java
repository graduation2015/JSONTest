...
public class CategoryMultipleChoiceDialog extends ChoiceDialog {
    ...
    protected Bundle makeArgs(Context context) {
        ...
        args.putStringArray(CategoryMultipleChoiceDialog.ITEMS, items);
        args.putBooleanArray(CategoryMultipleChoiceDialog.CHECKED_ITEMS, checkedItems);
